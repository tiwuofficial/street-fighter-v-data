const abigail = [
  ...
  },
  {
    ...
    stan: "150",
    remarks:
      "Can nullify projectiles (gain 30 CA gauge upon absorption)\nCauses blowback knockdown on mid-air hit",
    vtrigger: 1,
    type: "unique",
    command: "← + HP"
  },
  ...
  },
  {
    ...
    stan: "150",
    remarks:
      "Can nullify projectiles (2 hits, gain 30 CA gauge upon absorption)\nCauses blowback knockdown on mid-air hit",
    vtrigger: 1,
    type: "unique",
    command: "← + HP"
  },
  ...
  },
  {
    ...
    stan: "150",
    remarks:
      "1F - 37F  projectile invincibility\n                                                Can hit a knocked down opponent",
    vtrigger: 1,
    type: "special",
    command: "→↘↓↙← + P P"
  },
