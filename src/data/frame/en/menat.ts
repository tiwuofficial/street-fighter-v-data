const menat = [
  ...
  },
  {
    ...
    stan: "70",
    remarks:
      "S*Can only be canceled into Soul Sphere - Ankh and Soul Spark\nStanding/Crouching LP can be rapid canceled",
    vtrigger: 1,
    type: "normal",
    command: ""
  },
  ...
  },
  {
    ...
    stan: "70",
    remarks:
      "CA cancel can only be performed in close range on base hit\nS*Can canceled into Judgement of Thoth, Prophecy of Thoth",
    vtrigger: 2,
    type: "special",
    command: "(WITH THE CRYSTAL BALL) ↓↘→ + LP"
  },
