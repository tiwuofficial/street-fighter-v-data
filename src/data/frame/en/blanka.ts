const blanka = [
  ...
  },
  {
    ...
    stan: "",
    remarks:
      "Move duration can be extended by a max of 48F (total 104F) by continuing to hold in the down direction.",
    vtrigger: 1,
    type: "vsystem",
