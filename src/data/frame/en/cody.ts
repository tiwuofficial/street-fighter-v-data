const cody = [
  ...
  },
  {
    ...
    stan: "70",
    remarks:
      "Can rapid cancel into crouching LP, standing LK, and crouching LK\nUses 50 V-Timer gauge on hit (25 on block)",
    vtrigger: 1,
    type: "normal",
    command: ""
  },
  ...
  },
  {
    ...
    stan: "100",
    remarks:
      "Can be hit out of the air with a physical attack\nS*Can be whiff canceled into Reload",
    vtrigger: 1,
    type: "special",
  ...
  },
  {
    ...
    type: "special",
    command:
      "Press P 6F and later from the just frame timing, or don’t press anything after the throw"
  },
  {
    name: "Criminal Punisher",
    outbreak: "7",
