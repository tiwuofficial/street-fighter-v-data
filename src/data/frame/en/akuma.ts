const akuma = [
  ...
  },
  {
    ...
    damage: "60",
    stan: "80",
    remarks: "S*Can be canceled into Kiai on hit only",
    vtrigger: 1,
    type: "unique",
    command: "HP ▶ HP"
  },
  ...
  },
  {
    ...
    stan: "",
    remarks:
      "Parries standing/airborne attacks and projectiles\nSubject to counter hit during move duration",
    vtrigger: 1,
    type: "vsystem",
  ...
  },
  {
    ...
    stan: "",
    remarks:
      "Parries crouching attacks and projectiles\nSubject to counter hit during move duration",
    vtrigger: 1,
    type: "vsystem",
    command: "(WHEN SELECTING VSKILL I) ↓ + MP MK"
  },
  ...
  },
  {
    ...
    stan: "50 (*180)",
    remarks:
      "*1Denotes value of the flames; V Gauge gain becomes 0/90\n*2V Gauge gain becomes 0/50 if the projectile is canceled out by a projectile\nCan be charged; every frame charged after the 43rd frame increases the V Gauge by 1 frame (maximum gain of 300 frames)\nWhile holding, inputting Sekia Goshoha will activate the stronger version of the attack",
    vtrigger: 1,
    type: "vsystem",
  ...
  },
  {
    ...
    stan: "0",
    remarks:
      "1F - 20F  attack & projectile invincibility\n                                                Recover 200 stun upon activation\n*on hit",
    vtrigger: 1,
    type: "vsystem",
  ...
  },
  {
    ...
    outbreak: "5",
    persistence: "",
    rigidity: "4 frame(s) after landing(*9 frame(s) after landing)",
    hit: "D",
    guard: "",
    damage: "120",
    stan: "150",
  ...
  },
  {
    ...
    stan: "120(*120)",
    remarks:
      "Combo count increases greatly if the first hit does not connect\nCA*V*Only possible during 1st attack\n*When the first hit whiffs",
    vtrigger: 1,
    type: "special",
    command: "↓↙← + MK"
  },
  ...
  },
  {
    ...
    stan: "0",
    remarks:
      "Will not hit airborne opponents until frame 10F\n                1F - 11F  full invincibility",
    vtrigger: 1,
    type: "ca",
    command: "↓↘→ ↓↘→ + P"
  },
  ...
  },
  {
    ...
    stan: "100(*120)",
    remarks:
      "Cannot cancel into V-Trigger on whiff\nCauses grounded stun damage on hit, except for the initial startup and when the projectile dissipates\n*During release hit and projectile explosion\n*2Gauge increase on consecutive hits is 0/20/10Gauge increase of 10 for projectile explosion hit only\nS*Can cancel into V-special moves during V-Trigger",
    vtrigger: 2,
    type: "special",
    command: "↓↘→ + LP"
  },
