const balrog = [
  ...
  },
  {
    ...
    stan: "",
    remarks:
      "Changes the properties of the next Dash Straight or Charging Buffalo to be used\n(All Straights are strengthened on rush in V-Skill I)",
    vtrigger: 1,
    type: "vsystem",
  ...
  },
  {
    ...
    stan: "150",
    remarks:
      "3F - 18F  projectile invincibility\n                                                VS*Only possible before the attack\nVS*Can only be canceled V-Skill I",
    vtrigger: 1,
    type: "special",
  ...
  },
  {
    ...
    damage: "40",
    stan: "70",
    remarks: "S*Can only be canceled with B3",
    vtrigger: 2,
    type: "unique",
    command: "LK ▶ MK"
  },
  ...
  },
  {
    ...
    stan: "80",
    remarks:
      "Forces stand\n                                                                                                                S*Can only be canceled with B3",
    vtrigger: 2,
    type: "unique",
    command: "(WHILE CROUCHING) MK ▶ ↓ + MK"
  },
